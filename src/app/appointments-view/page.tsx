...
export default function AppointmentsStandalonePage() {
  ...
  return (
    <AuthGuard>
      <div className="container mx-auto px-4 md:px-8 py-12 space-y-6 min-h-screen">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-heading font-bold text-charcoal">Appointments Dashboard</h1>
